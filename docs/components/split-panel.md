...
```jsx react
import { SlSplitPanel } from '%PACKAGE_NAME%/dist/react';
...
import { SlSplitPanel, SlSelect, SlMenuItem } from '%PACKAGE_NAME%/dist/react';
...
```jsx react
import { SlSplitPanel, SlIcon } from '%PACKAGE_NAME%/dist/react';
