...
import { OPopup, OSelect, OMenuItem, OInput, OSwitch } from '%PACKAGE_NAME%/dist/react';
...
```jsx react
import { useState } from 'react';
import { OPopup, OSwitch } from '%PACKAGE_NAME%/dist/react';
...
```jsx react
import { OPopup } from '%PACKAGE_NAME%/dist/react';
...
```jsx react
import { useState } from 'react';
import { OPopup, OSelect, OMenuItem } from '%PACKAGE_NAME%/dist/react';
...
```jsx react
import { useState } from 'react';
import { OPopup, ORange } from '%PACKAGE_NAME%/dist/react';
...
```jsx react
import { useState } from 'react';
import { OPopup, OSelect, OMenuItem, OSwitch } from '%PACKAGE_NAME%/dist/react';
