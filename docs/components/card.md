...
```jsx react
import { OButton, OCard, ORating } from '%PACKAGE_NAME%/dist/react';
...
```jsx react
import { OCard } from '%PACKAGE_NAME%/dist/react';
...
```jsx react
import { OCard, OIconButton } from '%PACKAGE_NAME%/dist/react';
