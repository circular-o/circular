...
```jsx react
import { SlAlert, SlIcon } from '%PACKAGE_NAME%/dist/react';
...
```jsx react
import { SlAlert } from '%PACKAGE_NAME%/dist/react';
...
```jsx react
import { useState } from 'react';
import { SlAlert, SlButton, SlIcon } from '%PACKAGE_NAME%/dist/react';
