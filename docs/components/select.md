...
```jsx react
import { SlDivider, SlOption, SlSelect } from '%PACKAGE_NAME%/dist/react';
...
```jsx react
import { SlIcon, SlOption, SlSelect } from '%PACKAGE_NAME%/dist/react';
