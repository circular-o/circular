...
[component-header:o-grid]

It applies the default styles and provides a simple API to initialize the grid and then access the grid instance.

The grid instance can be used to call any Tabulator method. See the [Tabulator documentation](https://tabulator.info/docs/5.5) for more details.
