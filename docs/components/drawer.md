...
import { SlButton, SlDrawer } from '%PACKAGE_NAME%/dist/react';
...
```jsx react
import { useState } from 'react';
import { SlButton, SlDrawer, SlIconButton } from '%PACKAGE_NAME%/dist/react';
...
```jsx react
import { useState } from 'react';
import { SlButton, SlDrawer, SlInput } from '%PACKAGE_NAME%/dist/react';
