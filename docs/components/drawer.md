...
import { OButton, ODrawer } from '%PACKAGE_FULL_PATH%/dist/react';
...
```jsx react
import { useState } from 'react';
import { OButton, ODrawer, OIconButton } from '%PACKAGE_FULL_PATH%/dist/react';
...
```jsx react
import { useState } from 'react';
import { OButton, ODrawer, OInput } from '%PACKAGE_FULL_PATH%/dist/react';
