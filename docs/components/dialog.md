...
import { SlButton, SlDialog } from '%PACKAGE_NAME%/dist/react';
...
```jsx react
import { useState } from 'react';
import { SlButton, SlDialog, SlIconButton } from '%PACKAGE_NAME%/dist/react';
...
```jsx react
import { useState } from 'react';
import { SlButton, SlDialog, SlInput } from '%PACKAGE_NAME%/dist/react';
