...
import { OButton, ODialog } from '%PACKAGE_NAME%/dist/react';
...
```jsx react
import { useState } from 'react';
import { OButton, ODialog, OIconButton } from '%PACKAGE_NAME%/dist/react';
...
```jsx react
import { useState } from 'react';
import { OButton, ODialog, OInput } from '%PACKAGE_NAME%/dist/react';
