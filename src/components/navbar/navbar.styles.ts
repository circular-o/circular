...
export default css`
  ...
  :host {
    --background: var(--o-navbar-light-background-color, var(--o-color-neutral-0, white));
    --hamburger-background: var(--o-navbar-light-hamburger-background-color, transparent);
    --hamburger-background-hover: var(
      --o-navbar-light-hamburger-background-color-hover,
      var(--o-color-neutral-300, #f1f1f4)
    );
    --hamburger-background-active: var(
      --o-navbar-light-hamburger-background-color-active,
