...
export default css`
  ...
  .drawer__header-actions o-icon-button,
  .drawer__header-actions ::slotted(o-icon-button) {
    flex: 0 0 auto;
    display: flex;
    align-items: center;
  ...
  .drawer__footer ::slotted(o-button:not(:last-of-type)) {
