...
describe('<o-breadcrumb-item>', () => {
  ...
  describe('when not provided a href attribute', () => {
    before(async () => {
      el = await fixture<OBreadcrumbItem>(html` <o-breadcrumb-item>Home</o-breadcrumb-item> `);
    });
  ...
  describe('when provided a href attribute', () => {
    describe('and no target', () => {
      before(async () => {
        el = await fixture<OBreadcrumbItem>(html`
          <o-breadcrumb-item href="https://jsonplaceholder.typicode.com/">Home</o-breadcrumb-item>
        `);
      });
    ...
    describe('and target, without rel', () => {
      before(async () => {
        el = await fixture<OBreadcrumbItem>(html`
          <o-breadcrumb-item href="https://jsonplaceholder.typicode.com/" target="_blank">Help</o-breadcrumb-item>
        `);
      });
    ...
    describe('and target, with rel', () => {
      before(async () => {
        el = await fixture<OBreadcrumbItem>(html`
          <o-breadcrumb-item href="https://jsonplaceholder.typicode.com/" target="_blank" rel="alternate"
            >Help</o-breadcrumb-item
          >
        `);
      });
